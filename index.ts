import { second, minute, ms } from './time-units';
import { executeTrigger, getToken, type PeerState, type Trigger } from './utils';
import { VK } from 'vk-io';

const { handleOutgoingMessage } = require('./outgoing-messages');

const peers: Record<number, PeerState> = {}; // TODO: keep state about what triggers then last triggered for each peer
