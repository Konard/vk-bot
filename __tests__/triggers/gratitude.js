...
describe(triggerDescription, () => {
  ...
  test.each([
    ...
    ['От Всей Души✋👋'],
    ['Спасибо Константин! От всей души БЛАГОДАРЮ!'],
    ...
    ['Спасибо большое мужик!💪🏻🎉 обнял поднял 🙃'],
    ['Благодарю добра и любви твоему дому'],
