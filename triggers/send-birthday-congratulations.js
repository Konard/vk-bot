...
const paragraph5Variants = [
  ...
  "Если тебе интересно разгадать что такое связи и ассоциативность, включи музыку из видеоролика 🎼 и прочти нашу статью о теории, которая является результатом трудов всей моей жизни. Ссылку на статью можно найти в описании к видеоролику.",
